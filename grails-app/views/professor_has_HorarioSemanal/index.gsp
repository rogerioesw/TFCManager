...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'professor_has_HorarioSemanal.label', default: 'Horários Disponiveis para o Professor')}" />
			...
			<thead>
				...
				<g:each in="${professor_has_HorarioSemanalInstanceList}" status="i" var="professor_has_HorarioSemanalInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: professor_has_HorarioSemanalInstance, field: "horario")}</td>
